                    ...
                    $list.off().on('click',function(e){
                        ...
                        .on('click.span','.layui-btn',function(e){
                            if($(this).is('#timeOk')){
                                ...
                                $(this).parents('.ui-time').find('.ui-time-text').val(valTime).attr('kssj',kssj).attr('jssj',jssj);
                                $('#beginTime').val(kssj+'~'+jssj);
                                $list.off().remove();
                                global.inputWrapper.parent().css('zIndex', '');
                            }else{
                                $(this).parents('.ui-time').find('.ui-time-text').val('');
                                $(this).parents('.ui-time').find('.ui-time-text').attr('kssj','');
                                $(this).parents('.ui-time').find('.ui-time-text').attr('jssj','');
