...
function rewardInfo(number){
    ...
    ajaxAction("get",'/api/reward/back/'+number,"",true,function(data,textStatus){
        ...
        htmlInfo+='<div class="infoUserTitle"><span class="creditCard">债权ID：'+data.rewardId+'</span><span class="waitSigned">'+data.status+'</span></div><div class="infoUserCon" ><dl><dt>债权编号：</dt><dd>'+data.code+'</dd><dt>悬赏类型：</dt><dd>'+data.type+'</dd><dt>悬赏金额：</dt><dd>'+data.money+'万元</dd><dt>悬赏地址：</dt><dd>'+data.province+data.city+'</dd><dt>悬赏时间：</dt><dd>'+data.time+'</dd><dt>悬赏名称(姓名)：</dt><dd>'+data.name+'</dd><dt>联系人姓名：</dt><dd>'+data.contactName+'</dd><dt>联系人手机号：</dt><dd>'+data.contactTelephone+'</dd><ul class="pengzheng"><dt>凭证：</dt><div class="row"><div class="col-md-10 col-md-offset-2 cardUser"><ul><!--<li></li><li></li><li></li>--></ul><div class="cls"></div></div></div></ul><ul class="creditDescription"><dt>描述：</dt><dd><p>'+data.description+'</p></dd></ul><ul class="creditDescription"><dt>驳回理由：</dt><dd class="rejectReason"><p>'+data.refuseMessage+'</p></dd></ul></dl><div class="cls"></div></div>';
