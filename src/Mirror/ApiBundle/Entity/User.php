 ...
 * User
 *
 * @ORM\Table(name="user", uniqueConstraints={@ORM\UniqueConstraint(name="mobile", columns={"mobile"})}, indexes={@ORM\Index(name="role", columns={"role"}), @ORM\Index(name="status", columns={"status"})})
 * @ORM\Entity
 */
class User
{
