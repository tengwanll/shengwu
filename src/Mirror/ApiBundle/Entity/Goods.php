 ...
 * Goods
 *
 * @ORM\Table(name="goods", uniqueConstraints={@ORM\UniqueConstraint(name="name", columns={"name", "status"})}, indexes={@ORM\Index(name="sort", columns={"sort_id"}), @ORM\Index(name="price", columns={"price"})})
 * @ORM\Entity
 */
class Goods
{
